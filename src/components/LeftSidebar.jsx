...
function LeftSidebar({ onSettingsOpen }) {
  ...
  const tabs = [
    { id: 'chat', label: t('sidebar.tab_chat'), desc: 'All conversations', icon: MessageSquare },
    { id: 'image', label: t('sidebar.tab_image'), desc: 'Image generation', icon: Image },
    { id: 'video', label: t('sidebar.tab_video'), desc: 'Video generation', icon: Video },
    { id: 'batch', label: t('sidebar.tab_batch'), desc: 'Batch operations', icon: ListOrdered },
    { id: 'cache', label: t('sidebar.tab_cache'), desc: 'Context caching', icon: Database },
    { id: 'settings', label: t('sidebar.tab_settings'), desc: 'App settings', icon: Settings }
  ]
  ...
  const handleTabClick = (tabId) => {
    ...
    if (tabId === 'settings' && typeof onSettingsOpen === 'function') {
      onSettingsOpen()
    }
  }
  ...
  const renderTabContent = () => {
    ...
    if (activeTab === 'batch') {
      return <div className="sidebar-placeholder">Batch Jobs History</div>
    }
